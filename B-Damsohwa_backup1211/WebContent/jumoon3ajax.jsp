                    ...
                    <form method="get" action="MemberRootin">
                        <div class="form-row p-t-20">
                            ...
                            <div class="p-t-15">
                                <select name="time">
                                	...
                                	<% for(int i=1; i<=24; i++) {%>
                                	<option id="wakeH" name="wakeH" value="<%=i%>"><%=i+"시"%></option>
                                	<%}%>
                                </select>
                                ...
                                <select name="time">
                                	...
                                	<!-- <option disabled="disabled" selected="selected"> -->
                                	<% for(int i=1; i<=24; i++) {%>
                                	<option id="sleepH" name="sleepH" value="<%=i%>"><%=i+"시"%></option>
                                	<%}%>
                                </select>
                            </div>
                        </div>
                            	...
                            	<label class="label label--block">복용시간을 선택해 주세요</label>
                           		<div class="p-t-15">
                                	<select name="mediTake">
                                		...
                                		<option id="takeMediAP" name="takeMediAP">오전</option>
                                        <option>오후</option>
                                    </select>
                                	...
                                	<!-- <option disabled="disabled" selected="selected"> -->
                                	<% for(int i=1; i<=12; i++) {%>
                                	<option id="takeMediT1" name="takeMediT" value="<%=i%>"><%=i+"시"%></option>
                                	<%}%>
                                	</select>
                                	...
                                	<option id="takeMediM1" name="takeMediM" value="<%=i%>"><%=i+"분"%></option>
                                	<%}%>
                                	</select>
                              </div>
                        	  </div>
                          ...
                          <div id="mediTime2" style="display:none">
                            	...
                            	<% for(int j=1; j<=2; j++) {%>
                           		<div class="p-t-15">
                                	...
                                	<!-- <option disabled="disabled" selected="selected"> -->
                                	<% for(int i=1; i<=12; i++) {%>
                                	<option id="takeMediT" name="takeMediT" value="<%=i%>"><%=i+"시"%></option>
                                	<%}%>
                                	</select>
                                	...
                                	<!-- <option disabled="disabled" selected="selected"> -->
                                	<% for(int i=0; i<=59; i+=10) {%>
                                	<option id="takeMediM" name="takeMediM" value="<%=i%>"><%=i+"분"%></option>
                                	<%}%>
                                	</select>
                              </div>
                              <%}%>
						...
						function div1_OnOff(v,id){
							...
							if(v == "1"){
								...
								document.getElementById(id).style.display = "";
								document.getElementById("mediTime1").style.display = "none";
								document.getElementById("mediTime3").style.display = "none";
							}else if(v == "3"){
								document.getElementById(id).style.display = "";
								document.getElementById("mediTime1").style.display = "none";
                ...
                <section>
                     ...
                     <div class="form-row m-b-55">
                        ...
                        <div class="form-row m-b-55">
                            ...
                            <div>담소화 이미지</div>
                            <div>담소화 이름</div>
                            <div class="name">담소화의 생일은 현재날짜 입니다.</div> <!-- 주문자생일+담소화생일 -> 시리얼넘버 -->
                            <div class="name">벗님의 생일은 언제인가요? (예: 0101 _ 월일을 4자리 숫자로 입력해주세요)</div>
                            <div class="value">
                                <div class="row row-space">
                                    <div class="col-2">
                                        <div class="input-group-desc">
                                            <input class="input--style-5" type="text" name="birth">
                                        </div>
                                    </div>
