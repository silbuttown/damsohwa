                        ...
                        <div class="form-row p-t-20">
                            ...
                            <div> <!-- class="p-t-15" -->
                                ...
                                <label class="radio-container m-r-55">꽃
                                    <input type="radio" id="flora" name="radio1" value="flora" onchange="setDisplay()">
                                    <span class="checkmark"></span>
                                </label>
                                <label class="radio-container m-r-55">열매
                                    <input type="radio" id="crop" name="radio1" value="crop" onchange="setDisplay()">
                                    <span class="checkmark"></span>
                                </label>
                                <label class="radio-container m-r-55">기타
                                    <input type="radio" id="glue" name="radio1" value="glue" onchange="setDisplay()">
                                    <span class="checkmark"></span>
                                </label>
                            </div>
                        </div>
                ...
                $("input[name='radio1']:radio").change(function () {
            		...
            		if(plant == "flora"){
                    	...
                    	plant2img = "images/crop1.png";
              			...
              			plant = "glue";
                		plant1txt = "장미허브";
                		plant1img = "images/g1.jpg";
                    	plant2txt = "방울토마토";
                    	plant2img = "images/g2.jpg";
